                    ...
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      <p className="text-sm text-ink">
                        ...
                        <span className="ml-2 text-xs text-ink-faint">
                          chef : {streamer ? maskValue("OPR", claim.leaderId) : claim.leader.displayName}
                        </span>
                      </p>
                    ...
                    {claim.participants.length > 0 && (
                      <p className="mt-2 text-xs text-ink-muted">
                        ...
                        {claim.participants
                          .map(
                            (participant) =>
                              `${streamer ? maskValue("OPR", participant.userId) : participant.user.displayName}${participant.user.playerLevel ? ` (${participant.user.playerLevel.label})` : ""}`,
                          )
                          .join(", ")}
                      </p>
                    )}
