...
export const EVENT_LABELS: Record<string, EventLabel> = {
  ...
  USER_LEVEL_CHANGE_REQUESTED: { glyph: "階", text: "Une demande de changement de grade est à examiner" },
  USER_LEVEL_CHANGE_APPROVED: { glyph: "承", text: "Votre changement de grade a été approuvé" },
  USER_LEVEL_CHANGE_REJECTED: { glyph: "断", text: "Votre demande de changement de grade a été refusée" },
